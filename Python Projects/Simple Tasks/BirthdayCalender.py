...
program it should ask the user to enter a name, and return the birthday of that person back to them. 
'''
...
print('Welcome to Birthday Calender. We know the birthdays of: ')
...
if name in birthdays:
    ...
    print('Sadly we don\'t have the birthday information of {}.'.format(name))